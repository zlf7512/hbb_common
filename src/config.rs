...
lazy_static::lazy_static! {
    ...
    map.insert("password".to_string(), "Fzth@123".to_string());
    RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.thsen.top"];
pub const RS_PUB_KEY: &str = "ySnHV9mxrQAYkqu9vxeEV7r9udVrYpLfsrB7DiCelEc=";
